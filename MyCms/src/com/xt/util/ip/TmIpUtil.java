...
public class TmIpUtil {
	...
	public static String ipLocation(String ip) {
		String ipLocation = "";
		TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat","E:/Users/Administrator/Workspaces/MyEclipse Professional 2014/MyCms/WebRoot/ip");
...
//		System.out.println(ipprovince("114.252.129.17"));
		System.out.println(ipcity("116.23.24.130"));
